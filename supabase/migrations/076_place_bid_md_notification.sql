-- Migration 076: place_bid()에 MD 입찰 알림 추가
-- 날짜: 2026-03-27
-- 문제: 입찰 시 MD(경매 주인)에게 아무 알림이 없음
-- 해결: place_bid() 내에서 MD에게 md_new_bid 인앱 알림 생성
-- 스팸 방지: 동일 경매에서 5분 이내 MD 알림이 있으면 스킵
...
COMMENT ON FUNCTION place_bid(UUID, UUID, INTEGER) IS 'Migration 076: 070 기반 + MD 입찰 알림 (5분 쿨다운)';
