-- ============================================
-- place_bid(): scheduled 경매 자동 활성화
-- 문제: Cron이 1분 간격으로 scheduled→active 전환하므로,
--       시작 시간이 지났지만 아직 전환 안 된 경매에 입찰 시
--       "경매가 진행 중이 아닙니다 (현재: scheduled)" 에러 발생
-- 해결: place_bid() 내에서 scheduled + 시작시간 경과 시 자동 active 전환
-- ============================================
