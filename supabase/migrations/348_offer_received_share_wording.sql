-- ============================================================================
-- Migration 348: 제안 도착 알림 문구 조각/깃발 분기
-- 날짜: 2026-07-01
-- 설명: submit_offer()의 방장 알림 "MD가 회원님의 깃발에 제안서를 보냈습니다"가
--       조각(is_recruiting_party=true)에도 "깃발"로 떠서, is_recruiting_party로 분기.
--       (Migration 339 본문 그대로 복제 + 알림 message만 CASE 분기)
-- ============================================================================
