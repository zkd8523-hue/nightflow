-- 024: MD 수수료 0% 변경
-- 배경: 베타 기간 동안 MD 수수료를 부과하지 않음
-- 영향: place_bid() BIN 낙찰, close_auction() 일반 낙찰, transactions 기본값

-- 1. transactions 테이블 기본값 변경
ALTER TABLE transactions ALTER COLUMN md_commission_rate SET DEFAULT 0.00;

-- 2. place_bid() 재정의: 수수료 0%
