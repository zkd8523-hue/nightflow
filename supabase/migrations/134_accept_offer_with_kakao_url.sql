-- ============================================================================
-- Migration 134: accept_offer() — 카카오 오픈채팅 URL을 수락과 원자적으로 처리
-- 날짜: 2026-05-07
-- 설명: 방장 수락 시점에 URL을 함께 받아 단일 트랜잭션으로 저장.
--       URL 누락 상태로 수락이 완료되어 MD가 연락할 길이 사라지는 버그 차단.
--       (Migration 128의 schema 변경 의도를 RPC 차원에서 완성)
-- ============================================================================
