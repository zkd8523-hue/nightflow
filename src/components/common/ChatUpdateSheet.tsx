  ...
  return (
    <Sheet open={open} onOpenChange={(v) => { if (!v) dismiss(); }}>
      ...
      >
        ...
        <div className="space-y-3 pb-2 text-[14px] text-neutral-300 leading-relaxed">
          {isMd ? (
            <>
        ...
        <Button
          onClick={dismiss}
          className="w-full h-12 bg-white text-black font-black rounded-2xl mt-4 hover:bg-neutral-200"
        >
          확인했어요
        </Button>
      </SheetContent>
