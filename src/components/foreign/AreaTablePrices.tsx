...
const T = {
  ...
  "zh-tw": {
    h2: (a: string) => `${a}夜店桌位價格 — 低消與最便宜套餐`,
    intro: (a: string, n: number) => `可透過 NightFlow 訂桌的${n}家${a}夜店真實酒單價格。低消按每桌計,套餐價為各夜店酒單上最便宜的項目。無中介費,當晚在夜店付款。`,
    min: "每桌低消", set: "最便宜套餐", item: "最便宜酒水", book: "訂桌", reviews: "則評論",
