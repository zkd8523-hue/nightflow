        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-5 pt-8 pb-8 space-y-5">
                  ...
                  <div className="mt-2 px-0.5 space-y-0.5">
                    ...
                    <div className="pt-0.5">
                      <div className="flex items-baseline gap-1.5">
                        ...
                        <span className="text-[11px] text-neutral-500 line-through">120,000원</span>
                      </div>
                      <span className="text-[15px] font-black text-white">84,000원</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="bg-[#1C1C1E] border border-neutral-800 rounded-2xl p-4 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[13px] text-white font-bold">상세 페이지에 내 정보·혜택 공개</p>
            </div>
            <div className="bg-black/40 rounded-xl p-3 space-y-3">
              ...
              <div className="bg-neutral-900/60 rounded-lg px-3 py-2 space-y-1">
                <p className="text-white text-[13px] font-bold">🍾 테이블 1세트 + 프리드링크 2잔</p>
                <div className="flex items-baseline gap-1.5">
                  <span className="text-[11px] font-black text-red-400">30%</span>
                  <span className="text-[11px] text-neutral-500 line-through">120,000원</span>
                  <span className="text-[15px] font-black text-white">84,000원</span>
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-4 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[13px] text-white font-bold">게스트가 직접 연락 → 즉시 송객</p>
            </div>
            <div className="flex items-center justify-around bg-black/30 rounded-xl py-3">
              <div className="flex flex-col items-center gap-1">
                ...
                <span className="text-[10px] text-neutral-400 font-bold">DM</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <div className="w-10 h-10 rounded-full bg-green-500/20 flex items-center justify-center">
                  <Phone className="w-5 h-5 text-green-400" />
                </div>
                <span className="text-[10px] text-neutral-400 font-bold">전화</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <div className="w-10 h-10 rounded-full bg-yellow-500/20 flex items-center justify-center">
                  <MessageCircle className="w-5 h-5 text-yellow-400" />
                </div>
                <span className="text-[10px] text-neutral-400 font-bold">카톡</span>
              </div>
            </div>
