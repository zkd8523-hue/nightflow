...
export const metadata: Metadata = {
  ...
  openGraph: { title:"韩国夜店年龄限制与证件规定 2026", description:"2007年及以前出生。需护照或ARC原件。", url:"https://nightflow.kr/zh/club-entry-rules", locale:"zh_CN", type:"article", images:[{url:"/og-image.png",width:1200,height:630}] },
};
