...
export const metadata: Metadata = {
  ...
  description:
    "首尔最佳夜店预订 — 江南·弘大·梨泰院·狎鸥亭。真实价格，VIP 包间，无中介，无需韩语。选好夜店，我们直接为您预订。轻松搞定韩国夜生活。",
  keywords: [
    // 韩国 country-level
    "韩国夜店",
    "韩国夜店预订",
  ...
  return (
    <>
      ...
      <div className="sr-only">
        ...
        <p>
          选好想去的夜店 — 江南 Club ACE、弘大 Club Dokkaebi、梨泰院 Soap Seoul、狎鸥亭 Core Lounge 等 — 填写日期、人数、预算即可。不确定去哪家？告诉我们您的喜好，我们来推荐。NightFlow 会直接联系夜店，为您锁定最适合预算的桌位。无需韩语，无需 MD 联系人，无中介费。
        </p>

        <h2>首尔夜生活实时动态</h2>
        <p>
          目前有 {flagCount} 位旅客正在计划首尔（江南、弘大、梨泰院、狎鸥亭）的夜生活。选好夜店，我们直接为您预订 — 大多数请求几小时内就有回复。
        </p>

        <h2>通过 NightFlow 预订韩国夜店的优势</h2>
        <ul>
          <li>
            无需韩语 — 我们直接用中文/英文联系江南、弘大、梨泰院的夜店。
          </li>
          <li>
            真实价格 — 无中介加价，无隐藏费用。
          </li>
          <li>
            锁定预算内最好的桌位 — 瓶装服务、黄金位置、跳过排队。
          </li>
          <li>
