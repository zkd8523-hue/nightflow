...
export default async function ZhClubsAreaPage({
  ...
  const jsonLd = {
    ...
    "@graph": [
      marketFaqJsonLd("zh", marketArea, config.zh, `https://nightflow.kr/zh/clubs/${area}`),
      {
        "@type": "ItemList",
        "@id": `https://nightflow.kr/zh/clubs/${area}/#itemlist`,
        name: `${config.zh}夜店 — 首尔夜店预订`,
          ...
          return {
            ...
            item: {
              ...
              aggregateRating: c.google_rating
                ...
                : undefined,
              url: slug
                ? `https://nightflow.kr/zh/clubs/${area}/${slug}`
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "首尔夜店", item: "https://nightflow.kr/zh/clubs" },
          {
            "@type": "ListItem",
            position: 3,
            name: `${config.zh}夜店`,
            item: `https://nightflow.kr/zh/clubs/${area}`,
          },
        ],
      },
    ],
  ...
  return (
    <>
      ...
      <div className="sr-only">
        ...
        <ul>
          {clubList.map((c) => {
            ...
            return (
              <li key={c.id}>
                {slug ? <Link href={`/zh/clubs/${area}/${slug}`}>{label}</Link> : label}
              </li>
            );
          })}
        </ul>
      ...
      <div className="px-4 py-6 max-w-2xl mx-auto">
        <MarketFaq lang="zh" area={marketArea} areaLabel={config.zh} />
      </div>
