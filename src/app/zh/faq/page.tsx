...
const FAQS = [
  {
    q: "我不会韩语，能预订首尔夜店吗？",
    a: "可以。NightFlow 让外国游客全程用中文/英文预订首尔夜店。您插一面旗帜，填写日期、人数和预算，首尔夜店会向您发送专属 VIP 报价 — 无需韩语，无中介。",
  },
  {
    q: "外国人在首尔夜店一晚要花多少钱？",
  ...
  {
    q: "应该提前多久预订首尔夜店？",
    a: "最佳：出行前 3–7 天。可接受：24 小时前。最后底线：当天 — 仍可预订但报价较少。周五/周六是高峰之夜，竞争最激烈。",
  },
  {
    q: "需要押金或预订费吗？",
    a: "无预订费，无押金。在 NightFlow 插旗免费。接收报价免费。您只在接受报价并到场后直接付款给夜店 — 韩国本地价，无中介加价。",
  },
  {
    q: "没有韩国 MD 关系也能预订 VIP 包间吗？",
    a: "可以。传统首尔夜店预订需要韩国 MD（推广员）联系人。NightFlow 颠覆了这一切 — 夜店及其 MD 主动向您发送报价。您挑选最适合的方案。无需关系，无语言障碍。",
  },
  {
    q: "首尔夜店的着装要求是什么？",
  ...
  {
    q: "6 人以上的团体可以预订吗？",
    a: "可以。4–6 人最适合 VIP 包间（人均成本最优）。6 人以上可能需要预订相邻多桌。NightFlow 让您在插旗时指定团体人数，夜店会相应匹配。",
  },
  {
    q: "不订 VIP 包间，能跳过排队吗？",
  ...
  {
    q: "可以与陌生人拼桌降低成本吗？",
    a: "可以 — NightFlow 上称为'Share'（조각）。MD 出售高级桌的单个座位，您只需支付桌价的 1/N。单人游客或情侣想要 VIP 体验但又不想全包时非常合适。",
  },
];
