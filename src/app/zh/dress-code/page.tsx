...
export const metadata: Metadata = {
  ...
  openGraph: { title:"首尔夜店着装要求 2026", description:"江南严格、弘大自由。拖鞋哪里都不行。", url:"https://nightflow.kr/zh/dress-code", locale:"zh_CN", type:"article", images:[{url:"/og-image.png",width:1200,height:630}] },
};
