      ...
      <div className="max-w-3xl w-full space-y-8">
        ...
        <div className="bg-[#1C1C1E] border border-neutral-800 rounded-3xl p-8 space-y-6 text-neutral-300 text-[15px] leading-relaxed">
          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">1. 服务说明</h2>
            <p>NightFlow（运营公司：MadDawid，韩国）是首尔夜店预订中介平台。我们将国际游客与韩国夜店管理者（MD）连接，提供包间和VIP桌预订服务。</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">2. 使用资格</h2>
            <p>用户必须年满 19 周岁（韩国法定饮酒年龄）。注册即视为确认符合此要求。</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">3. 外国用户支付（Escrow）</h2>
            ...
            <ul className="space-y-1 list-disc pl-5 text-[14px]">
              ...
              <li>详见 <Link href="/zh/refund-policy" className="text-amber-400 underline">退款政策</Link></li>
            </ul>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">4. 用户责任</h2>
            <ul className="space-y-1 list-disc pl-5 text-[14px]">
              <li>提供准确的个人信息</li>
              <li>按约定时间到达夜店</li>
              <li>遵守夜店规定和韩国法律</li>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">5. 争议解决</h2>
            <p>争议首先由 NightFlow 客服处理，未解决的争议依据韩国法律，可提交至韩国消费者院或电子商务争议调解委员会。</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">6. 适用法律</h2>
            <p>本服务由韩国运营，适用韩国法律。</p>
          </section>
