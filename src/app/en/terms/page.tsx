      ...
      <div className="max-w-3xl w-full space-y-8">
        ...
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-4 text-[13px] text-brand-amber leading-relaxed">
          ...
          <p>
            ...
            <Link href="/terms" className="underline hover:text-brand-amber">
              nightflow.kr/terms
            </Link>
          </p>
        </div>
        ...
        <div className="bg-card border border-border rounded-3xl p-8 space-y-6 text-foreground/80 text-[15px] leading-relaxed">
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">1. Service Description</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">2. Eligibility</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">3. Foreign User Payment (Escrow)</h2>
            ...
            <ul className="space-y-1 list-disc pl-5 text-[14px]">
              ...
              <li>See full <Link href="/en/refund-policy" className="text-brand-amber underline">Refund Policy</Link></li>
            </ul>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">4. Booking & Cancellation</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">5. User Responsibilities</h2>
            <ul className="space-y-1 list-disc pl-5 text-[14px]">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">7. Governing Law</h2>
