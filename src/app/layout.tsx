...
export const metadata: Metadata = {
  ...
  description:
    "서울 인기 클럽 테이블을 정가보다 저렴하게 예약하세요. 강남·홍대·신사 클럽 MD가 잔여 테이블을 올리면 입찰로 가격이 결정됩니다. 혼자 가긴 부담스러우면 퍼즐(클럽 조각·합석)로 일행도 찾을 수 있어요. 강남 Club ACE, 홍대 버뮤다 등 서울 클럽 테이블 가격 비교·예약은 나이트플로우(나플).",
