...
export const metadata: Metadata = {
  ...
  description:
    "首爾最佳夜店預訂 — 江南·弘大·梨泰院·狎鷗亭。真實價格,VIP 包廂,無中介,無需韓語。選好夜店,我們協助您預訂。輕鬆搞定韓國夜生活。",
  keywords: [
    // 韓國 (번체)
    "韓國夜店",
    "韓國夜店預訂",
  ...
  return (
    <>
      ...
      <div className="sr-only">
        ...
        <h2>首爾夜生活即時動態</h2>
        <p>
          目前有 {flagCount} 位旅客正在規劃首爾(江南、弘大、梨泰院、狎鷗亭)的夜生活。選好夜店,我們協助您預訂 — 大多數請求數小時內就有回覆。
        </p>
      ...
      <EnHomeClient flags={flags} clubs={clubs} initialLang="zh-tw" openRequestCount={openRequestCount ?? null} recentBookings={recentBookings} />
    </>
  );
}
