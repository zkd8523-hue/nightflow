      ...
      <div className="max-w-3xl w-full space-y-8">
        ...
        <div className="bg-card border border-border rounded-3xl p-8 space-y-8 text-foreground/80 text-[15px] leading-relaxed font-medium">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">1. 適用範圍</h2>
            <p>本政策適用於外國用戶透過 NightFlow 平台進行的所有預付款交易。韓國國內用戶直接與夜店 MD 交易,不適用本退款政策。</p>
          </section>

          <section className="space-y-4">
            <h2 className="text-lg font-black text-foreground">2. 退款時間表</h2>
            <p>外國用戶預訂的退款依據距離<span className="text-foreground font-bold">活動時間</span>剩餘時間計算。</p>
            ...
            <div className="space-y-3 mt-4">
              <div className="bg-green-500/10 border border-green-500/30 rounded-2xl p-4 flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold text-money">活動前 48 小時以上取消</p>
                  <p className="text-[13px] text-muted-foreground mt-1"><span className="text-foreground font-bold">100% 退款</span>(PG 手續費由 NightFlow 承擔)</p>
                </div>
              </div>
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-4 flex items-start gap-3">
                <Clock className="w-5 h-5 text-brand-amber mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-bold text-brand-amber">活動前 24-48 小時取消</p>
          ...
          <section className="space-y-3">
            ...
            <ol className="space-y-2 list-decimal pl-5">
              ...
              <li>NightFlow 於 <span className="text-foreground font-bold">3 個工作日內</span>處理已核准的退款(依據韓國《電子商務消費者保護法》第 18 條)</li>
              <li>退款將退回至原付款方式</li>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">4. 夜店方取消</h2>
            <p>若因夜店方面原因取消預訂,用戶可獲得<span className="text-foreground font-bold">100% 退款</span>。相關 MD 可能依據公司政策承擔違約責任。</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">5. 付款處理</h2>
