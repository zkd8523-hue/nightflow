...
const FAQS = [
  {
    q: "我不會韓語,能預訂首爾夜店嗎?",
    a: "可以。NightFlow 讓外國遊客全程用繁體中文/英文預訂首爾夜店。您插一面旗幟,填寫日期、人數和預算,首爾夜店會向您發送專屬 VIP 報價 — 無需韓語,無中介。",
  },
  {
    q: "外國人在首爾夜店一晚要花多少錢?",
  ...
  {
    q: "應該提前多久預訂首爾夜店?",
    a: "最佳:出行前 3–7 天。可接受:24 小時前。最後底線:當天 — 仍可預訂但報價較少。週五/週六是高峰之夜,競爭最激烈。",
  },
  {
    q: "需要押金或預訂費嗎?",
    a: "無預訂費,無押金。在 NightFlow 插旗免費。接收報價免費。您只在接受報價並到場後直接付款給夜店 — 韓國本地價,無中介加價。",
  },
  {
    q: "沒有韓國 MD 關係也能預訂 VIP 包廂嗎?",
    a: "可以。傳統首爾夜店預訂需要韓國 MD(推廣員)聯絡人。NightFlow 顛覆了這一切 — 夜店及其 MD 主動向您發送報價。您挑選最適合的方案。無需關係,無語言障礙。",
  },
  {
    q: "首爾夜店的著裝要求是什麼?",
    a: "江南:smart casual 起步 — 不可穿人字拖、短褲、破洞牛仔褲。弘大:隨意,街頭風可以。梨泰院:國際化 smart casual。務必攜帶實體護照(韓國法律要求 ID 入場)。",
  },
  {
    q: "首爾夜店接受外國人嗎?",
  ...
  {
    q: "6 人以上的團體可以預訂嗎?",
    a: "可以。4–6 人最適合 VIP 包廂(人均成本最優)。6 人以上可能需要預訂相鄰多桌。NightFlow 讓您在插旗時指定團體人數,夜店會相應匹配。",
  },
  {
    q: "不訂 VIP 包廂,能跳過排隊嗎?",
  ...
  {
    q: "可以與陌生人拼桌降低成本嗎?",
    a: "可以 — NightFlow 上稱為'Share'(조각)。MD 出售高級桌的單個座位,您只需支付桌價的 1/N。單人遊客或情侶想要 VIP 體驗但又不想全包時非常合適。",
  },
];
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <div className="max-w-2xl mx-auto px-6 py-16 space-y-12">
        <header className="space-y-4 text-center">
          <Link href="/zh-tw" className="text-[12px] text-neutral-500 hover:text-white">
            ← NightFlow
          </Link>
