    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-start pt-20 px-4 pb-20">
      <div className="max-w-3xl w-full space-y-8">
        ...
        <div className="bg-card border border-border rounded-3xl p-8 space-y-6 text-foreground/80 text-[15px] leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">2. 付款資料(重要)</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">3. 資料用途</h2>
            <ul className="space-y-1 list-disc pl-5 text-[14px]">
              <li>帳戶管理與身分驗證</li>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">4. 資料共享</h2>
            <p>我們僅在下列情況共享資料:</p>
            <ul className="space-y-1 list-disc pl-5 text-[14px]">
            ...
            <p className="text-[13px] text-muted-foreground mt-2">我們不會向第三方出售您的個人資料。</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">5. 資料保留</h2>
            <ul className="space-y-1 list-disc pl-5 text-[14px]">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">6. 您的權利</h2>
            <ul className="space-y-1 list-disc pl-5 text-[14px]">
              <li>存取您的個人資料</li>
              <li>更正不正確的資料</li>
              <li>請求刪除帳戶</li>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">7. 聯絡</h2>
            <p>隱私相關問題:<a href="mailto:maddawids@gmail.com" className="text-brand-amber underline">maddawids@gmail.com</a></p>
          </section>
