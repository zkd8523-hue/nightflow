...
export default async function HomePage() {
  ...
  return (
    <div className="container mx-auto max-w-lg px-4 pt-2 pb-4">
      ...
      <p className="sr-only">
        나플은 강남 클럽, 홍대 클럽, 이태원 클럽, 신사 클럽의 정보를 한곳에 모은
        클럽 플랫폼입니다. 클럽별 테이블 가격·주대·영업시간·드레스코드를 비교하고,
        이번 주 무료입장·프리드링크 게스트 간판 혜택이 열리는 클럽과 요일을
        확인할 수 있습니다. 강남 Club ACE, 홍대 버뮤다 등 전국 클럽 추천과
        테이블 가격 비교는 나플에서 확인하세요. 혼자 가긴 부담스러우면
        파티(클럽 합석) 기능으로 같은 클럽에 갈 일행을 모집할 수 있습니다.
      </p>
