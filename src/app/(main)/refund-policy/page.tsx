      ...
      <div className="max-w-3xl w-full space-y-8">
        ...
        <div className="bg-[#1C1C1E] border border-neutral-800 rounded-3xl p-8 space-y-8 text-neutral-300 text-[15px] leading-relaxed font-medium">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">제 1조 (적용 범위)</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-lg font-black text-white">제 2조 (환불 기준)</h2>
            <p>
              외국인 사용자의 깃발 매칭 선결제 거래에 대해 다음과 같이 환불을 진행합니다.
              환불 기준 시점은 <span className="text-white font-bold">예약 이벤트 일시</span>입니다.
            </p>
            ...
            <div className="space-y-3 mt-4">
              <div className="bg-green-500/10 border border-green-500/30 rounded-2xl p-4 flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold text-green-300">방문 48시간 이전 취소</p>
                  <p className="text-[13px] text-neutral-400 mt-1">
                    결제 금액의 <span className="text-white font-bold">100% 환불</span>
                    {" "}(PG 결제 수수료는 회사가 부담)
                  </p>
                </div>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-4 flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold text-amber-300">방문 24~48시간 전 취소</p>
                  <p className="text-[13px] text-neutral-400 mt-1">
                    결제 금액의 <span className="text-white font-bold">50% 환불</span>
                  </p>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[13px] text-neutral-400 mt-1">
                    환불 <span className="text-white font-bold">불가 (0%)</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* 제3조: 환불 처리 절차 */}
          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">제 3조 (환불 처리 절차)</h2>
            <ol className="space-y-2 list-decimal pl-5">
              <li>사용자가 마이페이지 또는 고객센터를 통해 취소 신청</li>
              <li>회사가 시각 기준(예약 이벤트 일시 대비)으로 환불 비율 자동 산정</li>
              <li>회사는 <span className="text-white font-bold">취소 승인 후 영업일 기준 3일 이내</span>에 환불을 진행합니다.
          ...
          {/* 제4조: 청약철회 권리 */}
          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">제 4조 (청약철회의 제한)</h2>
            <p>
          ...
          {/* 제5조: MD 측 취소 */}
          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">제 5조 (MD 측 취소)</h2>
            <p>
          ...
          {/* 제6조: 결제대행사 */}
          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">제 6조 (결제대행사)</h2>
            <p>
          ...
          {/* 제7조: 분쟁 처리 */}
          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">제 7조 (분쟁 처리)</h2>
            <p>
          ...
          {/* 제8조: 정책 변경 */}
          <section className="space-y-3">
            <h2 className="text-lg font-black text-white">제 8조 (정책 변경)</h2>
            <p>
          ...
          <section className="space-y-3 pt-6 border-t border-neutral-800">
            <h2 className="text-lg font-black text-white">사업자 정보</h2>
        ...
        <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div className="text-[13px] text-neutral-300">
            <p className="font-bold text-amber-300 mb-1">고객 지원이 필요하신가요?</p>
            <p>
              환불·취소 관련 문의는{" "}
              <Link href="/contact" className="text-amber-400 underline hover:text-amber-300">
                고객문의
              </Link>{" "}
              또는 <a href={`mailto:${BUSINESS_INFO.email}`} className="text-amber-400 underline hover:text-amber-300">
                {BUSINESS_INFO.email}
              </a>로 연락해주세요.
            </p>
          </div>
