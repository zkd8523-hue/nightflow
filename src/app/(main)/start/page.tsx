  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-black text-white tracking-tight break-keep">원하는 방식으로 클럽을 예약해보세요</h1>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <p className="text-[18px] font-black text-white mt-3">깃발</p>
          ...
          >
            <span className="text-[34px] leading-none">🧩</span>
            <p className="text-[18px] font-black text-white mt-3">조각</p>
            <p className="text-[12.5px] text-neutral-400 mt-1.5 leading-relaxed break-keep flex-1">
