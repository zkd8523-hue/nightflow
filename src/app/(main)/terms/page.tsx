...
export const metadata: Metadata = {
  title: "이용약관",
  description:
    "나플 서비스 이용약관. 회원과 파트너(MD)의 권리·의무, 게스트 간판·파티·테이블 거래 관련 정책을 안내합니다.",
            ...
            <div className="max-w-3xl w-full space-y-8">
                ...
                <div className="bg-card border border-border rounded-3xl p-8 space-y-8 text-foreground/80 text-[15px] leading-relaxed font-medium">
                    ...
                    <section className="space-y-3">
                        <h2 className="text-lg font-black text-foreground">제 1조 (목적)</h2>
                        <p>본 약관은 NightFlow 서비스(이하 "서비스")가 제공하는 클럽 테이블 경매 중개 서비스의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.</p>
                    </section>

                    {/* 제2조: 용어 정의 */}
                    <section className="space-y-3">
                        <h2 className="text-lg font-black text-foreground">제 2조 (용어의 정의)</h2>
                        <div className="space-y-2">
                            <p><span className="text-foreground font-bold">1. "회사"</span>란 NightFlow를 운영하는 사업자를 의미합니다.</p>
                            <p><span className="text-foreground font-bold">2. "회원"</span>이란 본 약관에 동의하고 서비스를 이용하는 자를 의미합니다.</p>
                            <p><span className="text-foreground font-bold">3. "MD"</span>란 클럽과 파트너십을 맺고 테이블 경매를 등록하는 마케팅 담당자를 의미합니다.</p>
                            <p><span className="text-foreground font-bold">4. "경매"</span>란 MD가 등록한 테이블에 대해 회원들이 입찰하는 방식의 거래를 의미합니다.</p>
                            <p><span className="text-foreground font-bold">5. "낙찰"</span>이란 경매 종료 시점에 가장 높은 금액을 입찰한 회원이 해당 테이블을 구매할 권리를 획득하는 것을 의미합니다.</p>
                            <p><span className="text-foreground font-bold">6. "노쇼"</span>란 낙찰 후 제한 시간 내에 MD에게 연락하지 않거나 방문하지 않은 경우를 의미합니다.</p>
                        </div>
                    </section>
                    ...
                    {/* 제4조: 서비스 이용 제한 */}
                    <section className="space-y-3">
                        <h2 className="text-lg font-black text-foreground">제 4조 (서비스 이용 제한)</h2>
                        <div className="space-y-2">
                            <p className="text-foreground font-bold">① 경고 및 스트라이크 제도</p>
                            ...
                            <p className="text-foreground font-bold mt-4">② 기타 이용 제한 사유</p>
                            ...
                            <p className="text-foreground font-bold mt-4">③ 이의 제기</p>
                    ...
                    {/* 제5조: 경매 규칙 */}
                    <section className="space-y-3">
                        <h2 className="text-lg font-black text-foreground">제 5조 (경매 규칙)</h2>
                        <div className="space-y-2">
                            <p className="text-foreground font-bold">① 입찰 규칙</p>
                            ...
                            <p className="text-foreground font-bold mt-4">② 낙찰 및 연락</p>
                            ...
                            <p className="text-foreground font-bold mt-4">③ 테이블 이용</p>
                    ...
                    {/* 제6조: 금전 거래 및 수수료 */}
                    <section className="space-y-3">
                        <h2 className="text-lg font-black text-foreground">제 6조 (금전 거래 및 수수료)</h2>
                        <div className="space-y-2">
                            <p className="text-foreground font-bold">① 거래 방식</p>
                            ...
                            <p className="text-foreground font-bold mt-4">② 플랫폼 수수료</p>
                            <p className="pl-4">1. 회원(낙찰자) 및 테이블 이용 금액에 대한 별도 수수료는 없습니다.</p>
                            <p className="pl-4">2. MD(파트너)는 플랫폼 기능 이용을 위해 유료 크레딧을 충전하여 사용할 수 있습니다.</p>
                            <p className="pl-4">3. 향후 수수료 정책 변경 시 사전에 공지합니다.</p>

                            <p className="text-foreground font-bold mt-4">③ 크레딧 충전 및 환불</p>
                            <p className="pl-4">1. 크레딧은 MD가 플랫폼 기능(오퍼 제안, 매치 수수료 등) 이용을 위해 충전하는 유료 디지털 재화이며, 1크레딧의 가격은 100원(부가세 포함)입니다.</p>
                            <p className="pl-4">2. 크레딧은 카카오페이 등 결제대행사(PG)를 통해 결제되며, 결제 완료 즉시 회원 계정에 적립됩니다.</p>
                            <p className="pl-4">3. 충전한 크레딧의 유효기간은 무기한으로, 별도의 소멸 기한 없이 사용 시점까지 유지됩니다.</p>
                            <p className="pl-4">4. 사용하지 않은 크레딧은 충전일로부터 7일 이내에 고객센터(maddawids@gmail.com)를 통해 결제 수단으로 전액 환불받을 수 있습니다.</p>
                    ...
                    {/* 제7조: 낙찰 취소 및 분쟁 */}
                    <section className="space-y-3">
                        <h2 className="text-lg font-black text-foreground">제 7조 (낙찰 취소 및 분쟁)</h2>
                        <div className="space-y-2">
                            <p className="text-foreground font-bold">① 낙찰 취소</p>
                            ...
                            <p className="text-foreground font-bold mt-4">② 금전 거래 분쟁</p>
                    ...
                    {/* 제8조: 손해배상 및 면책 */}
                    <section className="space-y-3">
                        <h2 className="text-lg font-black text-foreground">제 8조 (손해배상 및 면책)</h2>
                        <div className="space-y-2">
                            <p className="text-foreground font-bold">① 회사의 책임</p>
                            ...
                            <p className="text-foreground font-bold mt-4">② 회사의 면책</p>
                            ...
                            <p className="text-foreground font-bold mt-4">③ 배상 한도</p>
                    ...
                    {/* 제9조: 분쟁 해결 */}
                    <section className="space-y-3">
                        <h2 className="text-lg font-black text-foreground">제 9조 (분쟁 해결)</h2>
                        <div className="space-y-2">
                            <p className="text-foreground font-bold">① 분쟁 조정 절차</p>
                            <p className="pl-4">1. <span className="text-brand-amber font-bold">1차: 고객센터 협의</span></p>
                            <p className="pl-6">- 고객센터(maddawids@gmail.com)로 분쟁 내용 접수</p>
                            <p className="pl-6">- 접수일로부터 7영업일 이내 답변</p>

                            <p className="pl-4 mt-2">2. <span className="text-brand-amber font-bold">2차: 소비자분쟁조정위원회</span></p>
                            <p className="pl-6">- 한국소비자원 1372 (www.ccn.go.kr)</p>
                            <p className="pl-6">- 조정 신청 후 30일 이내 결정</p>

                            <p className="pl-4 mt-2">3. <span className="text-brand-amber font-bold">3차: 소송</span></p>
                            <p className="pl-6">- 민사소송법에 따른 관할 법원 제기</p>

                            <p className="text-foreground font-bold mt-4">② 관할 법원</p>
                            <p className="pl-4">본 약관과 관련된 소송은 서울중앙지방법원을 전속 관할 법원으로 합니다.</p>

                            <p className="text-foreground font-bold mt-4">③ 준거법</p>
                    ...
                    {/* 제10조: 저작권 및 지식재산권 */}
                    <section className="space-y-3">
                        <h2 className="text-lg font-black text-foreground">제 10조 (저작권 및 지식재산권)</h2>
                        <div className="space-y-2">
                            <p className="text-foreground font-bold">① 회사의 권리</p>
                            ...
                            <p className="text-foreground font-bold mt-4">② 회원의 권리</p>
                            <p className="pl-4">1. 회원이 서비스에 직접 업로드한 콘텐츠(프로필 이미지, 리뷰 등)의 저작권은 회원에게 있습니다.</p>
                            ...
                            <p className="pl-4 mt-2 text-[12px] text-brand-amber dark:text-brand-amber/80">
                                ※ 프로필 사진은 회원이 프로필 설정에서 직접 업로드한 경우에만 저장됩니다.
                                카카오 OAuth로부터 전달받는 프로필 사진은 서버에 저장되지 않으며, 회원은
                                언제든지 업로드한 사진을 삭제할 수 있습니다. 업로드된 사진은 다른 회원에게
                                노출될 수 있음(예: 입찰 기록, MD 프로필)을 명시적으로 동의합니다.
                            </p>
                        </div>
                    </section>
                    ...
                    {/* 제11조: 약관 변경 */}
                    <section className="space-y-3">
                        <h2 className="text-lg font-black text-foreground">제 11조 (약관의 변경)</h2>
                        <div className="space-y-2">
                            <p className="text-foreground font-bold">① 변경 절차</p>
                            <p className="pl-4">1. 회사는 약관규제법, 전자상거래법 등 관련 법령을 위반하지 않는 범위에서 본 약관을 변경할 수 있습니다.</p>
                            <p className="pl-4">2. 약관 변경 시 변경 사유 및 적용 일자를 명시하여 <span className="text-brand-amber font-bold">최소 7일 전</span> 홈페이지에 공지합니다.</p>
                            <p className="pl-4">3. 회원에게 불리한 중대한 변경인 경우 <span className="text-brand-amber font-bold">30일 전</span> 공지하며, 이메일로 개별 통지합니다.</p>

                            <p className="text-foreground font-bold mt-4">② 동의 간주</p>
                    ...
                    <section className="space-y-3 pt-8 border-t border-border">
                        <h2 className="text-lg font-black text-foreground">부칙</h2>
                        <div className="text-muted-foreground text-sm space-y-1">
                            <p><span className="text-foreground font-bold">제1조 (시행일)</span> 본 약관은 2026년 3월 1일부터 시행합니다.</p>
                            <p><span className="text-foreground font-bold">제2조 (경과 조치)</span> 본 약관 시행 전에 발생한 사항에 대해서는 종전 약관을 적용합니다.</p>
                        </div>
                        ...
                        <div className="pt-6 bg-amber-500/10 border border-amber-500/20 rounded-xl p-4">
                            <p className="text-brand-amber text-sm font-bold">📋 고객센터</p>
                            <p className="text-foreground/80 text-sm mt-2">이용약관에 대한 문의사항은 고객센터로 연락 주시기 바랍니다.</p>
