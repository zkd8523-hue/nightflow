      ...
      <div className="max-w-3xl w-full space-y-8">
        ...
        <div className="bg-card border border-border rounded-3xl p-8 space-y-8 text-foreground/80 text-[15px] leading-relaxed font-medium">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc list-inside space-y-1 text-foreground/80">
              <li>신규 게스트 간판(무료입장·프리드링크)·핫딜·파티 등 서비스 내 혜택 및 거래 기회 안내</li>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">3. 수신 시간</h2>
            <p>
              광고성 정보는 원칙적으로 <strong className="text-foreground">오전 8시 ~ 오후 9시</strong>에 발송합니다.
            </p>
            <p className="text-[13px] text-muted-foreground">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">4. 보유 및 이용 기간</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">5. 동의 철회 방법</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-black text-foreground">6. 동의 거부 시 불이익</h2>
            <p>
