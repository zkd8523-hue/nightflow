...
export const metadata: Metadata = {
  ...
  description:
    "ソウルのベストクラブ予約 — 江南・弘大・梨泰院・狎鴎亭。本物の価格、VIPルーム、ブローカーなし、韓国語不要。クラブを選ぶだけ、あとは予約をお手伝いします。韓国ナイトライフを楽しもう。",
  keywords: [
    // 韓国 country-level
    "韓国クラブ",
    "韓国クラブ予約",
  ...
  return (
    <>
      ...
      <div className="sr-only">
        ...
        <h2>ソウルナイトライフの今</h2>
        <p>
          現在{flagCount}人がソウル（江南・弘大・梨泰院・狎鴎亭）でナイトライフを計画中です。クラブを選べば、あとは予約をお手伝いします — ほとんどのリクエストは数時間以内に返信があります。
        </p>
