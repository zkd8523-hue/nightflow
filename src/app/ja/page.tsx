...
export const metadata: Metadata = {
  ...
  description:
    "ソウルのベストクラブ予約 — 江南・弘大・梨泰院・狎鴎亭。本物の価格、VIPルーム、ブローカーなし、韓国語不要。クラブを選ぶだけ、あとは私たちが直接予約します。韓国ナイトライフを楽しもう。",
  keywords: [
    // 韓国 country-level
    "韓国クラブ",
    "韓国クラブ予約",
  ...
  return (
    <>
      ...
      <div className="sr-only">
        ...
        <p>
          NightFlowは日本人旅行者のための韓国クラブ予約プラットフォームです。韓国語不要で、ソウルの江南・弘大・梨泰院・狎鴎亭のトップクラブVIPルームを簡単に予約できます。本物の価格、ブローカーなし、隠れた手数料なし。行きたいクラブを選ぶ（または予算と雰囲気だけ伝える）だけで、NightFlowが直接クラブに連絡し席を確保します。K-POPクラブ、バー、ヒップホップナイトクラブ、高級VIPラウンジまで、NightFlowが日本語フレンドリーに対応します。
        </p>
        ...
        <p>
          行きたいクラブを選んでください — 江南Club ACE、弘大Club Dokkaebi、梨泰院Soap Seoul、狎鴎亭Core Loungeなど — 日付・人数・予算と一緒に。どこがいいか分からなければ、雰囲気だけ伝えてください。おすすめします。NightFlowが直接クラブに連絡し、予算内で一番良い席を確保します。韓国語不要、MDコンタクト不要、ブローカー手数料なし。
        </p>

        <h2>ソウルナイトライフの今</h2>
        <p>
          現在{flagCount}人がソウル（江南・弘大・梨泰院・狎鴎亭）でナイトライフを計画中です。クラブを選べば、あとは私たちが直接予約します — ほとんどのリクエストは数時間以内に返信があります。
        </p>

        <h2>NightFlowで韓国クラブを予約するメリット</h2>
        <ul>
          <li>
            韓国語不要 — 江南・弘大・梨泰院のクラブに日本語/英語で直接連絡します。
          </li>
          <li>
            本物の価格 — ブローカー手数料なし、隠れた費用なし。
          </li>
          <li>
            予算内で一番良い席を確保 — ボトルサービス、ゴールデンロケーション、列スキップ。
          </li>
          <li>
            プラットフォーム料金ゼロ — クラブに直接支払い、NightFlowは手数料を取りません。
          </li>
          <li>
            リクエスト送信無料、手数料なし、デポジット不要。
          </li>
        </ul>
