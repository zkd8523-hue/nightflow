  ...
  return (
    <>
      <div className="sr-only">
        ...
        <p>
          旗を立てて、日付・人数・予算を入力。{config.ja}クラブから数時間以内にプライベートVIPオファーが届きます。1つの画面で価格・席を比較、ワンタップで予約。韓国語不要、ブローカー手数料なし、デポジット不要。到着後、クラブに直接支払い。
        </p>

        <h2>NightFlowで{config.ja}クラブを予約するメリット</h2>
        <ul>
          <li>英語・日本語フレンドリー — {config.ja}クラブが主動でコンタクト。</li>
          <li>本物の価格 — プライベートオファーはあなただけが見える、ブローカー手数料なし。</li>
