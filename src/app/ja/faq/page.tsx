...
const FAQS = [
  { q: "韓国語が話せませんが、ソウルクラブを予約できますか？", a: "可能です。NightFlowは外国人旅行者が完全に日本語・英語でソウルクラブを予約できるサービスです。旗を立てて日付・人数・予算を入力すると、ソウルクラブからプライベートVIPオファーが届きます — 韓国語不要、ブローカーなし。" },
  ...
  { q: "ソウルクラブはどれくらい前に予約すべきですか？", a: "ベスト：旅行の3–7日前。許容：24時間前。最後の手段：当日 — まだ予約可能ですがオファーが少ない。金曜・土曜のピーク夜は最も競争が激しい。" },
  { q: "予約手数料やデポジットはありますか？", a: "予約手数料なし、デポジットなし。NightFlowで旗を立てるのは無料。オファー受信も無料。オファーを受け入れて到着した時にクラブに直接支払うだけ — 韓国人価格、ブローカー手数料なし。" },
  { q: "韓国MDのコネがなくてもVIPルームを予約できますか？", a: "可能です。従来のソウルクラブ予約には韓国のMD（プロモーター）コンタクトが必要でした。NightFlowはこれを逆転 — クラブとMDがあなたにオファーを送信。あなたが最適なものを選ぶ。コネ不要、言語の壁なし。" },
  ...
  { q: "6人以上のグループでも予約できますか？", a: "可能です。4–6人がVIPルームに最適（一人あたりのコストが最良）。6人以上は隣接する複数テーブルの予約が必要な場合があります。NightFlowで旗を立てる時にグループ人数を指定でき、クラブが対応します。" },
  ...
  { q: "見知らぬ人とテーブルをシェアしてコストを下げられますか？", a: "可能です — NightFlowでは「Share」（조각）と呼ばれます。MDがプレミアムテーブルの個別席を販売、テーブル料金の1/Nだけ支払います。VIPアクセスが欲しいがグループコストは避けたい一人旅行者やペアに最適。" },
];
