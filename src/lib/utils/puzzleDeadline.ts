...
export function formatKstHourLabelKo(iso: string): string {
  const kstHour = new Date(new Date(iso).getTime() + KST_OFFSET * 60 * 60 * 1000).getUTCHours();
